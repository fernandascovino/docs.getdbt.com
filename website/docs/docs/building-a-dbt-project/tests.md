...
<File name='tests/test_total_payment_amount_is_positive.sql'>
...
The name of this test is the name of the file: `test_total_payment_amount_is_positive`. Simple enough.
...
<File name='tests/generic/test_not_null.sql'>
